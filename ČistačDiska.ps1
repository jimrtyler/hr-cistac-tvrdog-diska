...
#GUI Variables
$FormTitleText = "Čistač diska Jima Tylera (PowerShellEngineer.com)"
...
$CreditLabelText = "Skripta Jima Tylera - PowerShellEngineer.com"
$LogFileLocatedText = "Pronađena datoteka dnevnika"
$AnalyzingDriveText = "Analiziranje pogona..."
$BrowsersAreRunningText = "Preglednici rade... Obavijesti korisnika..."
$PleaseCloseBrowsersText = "Molimo zatvorite sve web preglednike i pokušajte ponovo."
$CleaningDriveText = "Čišćenje pogona..."
